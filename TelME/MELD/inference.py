...
def main(args):
    ...
    model_t.load_state_dict(torch.load(os.path.join(ckpt_dir, 'teacher.bin'), map_location=device))
    ...
    audio_s.load_state_dict(torch.load(os.path.join(ckpt_dir, 'student_audio', 'total_student.bin'), map_location=device))
    ...
    video_s.load_state_dict(torch.load(os.path.join(ckpt_dir, 'student_video', 'total_student.bin'), map_location=device))
    ...
    fusion.load_state_dict(torch.load(os.path.join(ckpt_dir, 'total_fusion.bin'), map_location=device))
